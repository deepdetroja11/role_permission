                                ...
                                <div class="col-8">
                                    <div class="mt-0 text-left"> <span class="fs-14 font-weight-semibold">Total
                                        ...
                                        <span class="text-muted">
                                            <span class="text-success fs-12 mt-2 mr-1"><i
                                                    class="feather feather-arrow-up-right mr-1 bg-success-transparent p-1 brround"></i>124</span>
                                            for last month
                                        </span>
                                    </div>
                                </div>
                ...
                <div class="pt-2">
                    <div class="list-group">
                        <div class="list-group-item d-flex pt-3 pb-3 align-items-center border-0">
                            <div class="mr-3 mr-xs-0">
                                <div class="calendar-icon icons">
                                    <div class="date_time bg-pink-transparent"> <span class="date">18</span> <span
                                            class="month">FEB</span> </div>
                                </div>
                            </div>
                            <div class="ml-1">
                                <div class="h5 fs-14 mb-1">Board meeting Completed</div> <small class="text-muted">attend
                                    the company mangers...</small>
                            </div>
                        </div>
                        <div class="list-group-item d-flex pt-3 pb-3 align-items-center border-0">
                            <div class="mr-3 mr-xs-0">
                                <div class="calendar-icon icons">
                                    <div class="date_time bg-success-transparent "> <span class="date">16</span> <span
                                            class="month">FEB</span> </div>
                                </div>
                            </div>
                            <div class="ml-1">
                                <div class="h5 fs-14 mb-1"><span class="font-weight-normal">Updated the Company</span>
                                    Policy</div>
                        ...
                        <div class="list-group-item d-flex pt-3 pb-3 align-items-center border-0">
                            <div class="mr-3 mr-xs-0">
                                <div class="calendar-icon icons">
                                    <div class="date_time bg-orange-transparent "> <span class="date">17</span> <span
                                            class="month">FEB</span> </div>
                                </div>
                            </div>
                            <div class="ml-1">
                                <div class="h5 fs-14 mb-1">Office Timings Changed</div> <small class="text-muted"> this
                                    effetct after March 01st 9:00 Am To 5:00 Pm</small>
                            </div>
                        </div>
                        <div class="list-group-item d-flex pt-3 pb-5 align-items-center border-0">
                            <div class="mr-3 mr-xs-0">
                                <div class="calendar-icon icons">
                                    <div class="date_time bg-info-transparent "> <span class="date">26</span> <span
                                            class="month">JAN</span> </div>
                                </div>
                            </div>
                            <div class="ml-1">
                                <div class="h5 fs-15 mb-1"> Republic Day Celebrated </div> <small
                                    class="text-muted">participate the all employess </small>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="mb-4">
                ...
                <ul class="vertical-scroll pt-4 ">
                        ...
                        <div class="card p-4 ">
                            <div class="d-flex">
                                <img src="{{ asset('assets') }}/images/users/16.jpg" alt="img"
                                    class="avatar avatar-md bradius mr-3">
                                <div class="mr-3 mt-0 mt-sm-1 d-block">
                                    <h6 class="mb-1">Vanessa James</h6>
                                    <span class="clearfix"></span>
                                    <small>Birthday on Feb 16</small>
                                </div>
                                <span class="avatar bg-primary ml-auto bradius mt-1"> <i
                    ...
                    <li class="item">
                        <div class="card p-4 ">
                            <div class="d-flex comming_events calendar-icon icons">
                                <span class="date_time bg-success-transparent bradius mr-3"><span
                    ...
                    <li class="item">
                        <div class="card p-4 ">
                            <div class="d-flex">
                                <img src="{{ asset('assets') }}/images/users/4.jpg" alt="img"
                                    class="avatar avatar-md bradius mr-3">
                                <div class="mr-3 mt-0 mt-sm-1 d-block">
                    ...
                    <li class="item">
                        <div class="card p-4 ">
                            <div class="d-flex comming_events calendar-icon icons">
                                <span class="date_time bg-pink-transparent bradius mr-3"><span
        ...
        <div class="col-xl-4 col-md-12 col-lg-6">
            <div class="card">
                <div class="card-header border-0">
                    ...
                    <div class="card-options">
                        <div class="dropdown"> <a href="#" class="btn btn-outline-light" data-toggle="dropdown"
                                aria-expanded="false"> Week <i class="feather feather-chevron-down"></i> </a>
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                <li><a href="#">Monthly</a></li>
                                <li><a href="#">Yearly</a></li>
                                <li><a href="#">Weekly</a></li>
                ...
                <div class="card-body">
                    ...
                    <div class="sales-chart mt-4 row text-center">
                        <div class="d-flex my-auto col-sm-4 mx-auto text-center justify-content-center"><span
                                class="dot-label bg-primary mr-2 my-auto"></span>On progress</div>
                        <div class="d-flex my-auto col-sm-4 mx-auto text-center justify-content-center"><span
                                class="dot-label bg-secondary mr-2 my-auto"></span>Pending</div>
                        <div class="d-flex my-auto col-sm-4 mx-auto text-center justify-content-center"><span
                                class="dot-label bg-light4  mr-2 my-auto"></span>Completed</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-4 col-md-12 col-lg-6">
            <div class="card">
                <div class="card-header border-0">
                    ...
                    <div class="card-options">
                        <div class="dropdown"> <a href="#" class="btn btn-outline-light" data-toggle="dropdown"
                                aria-expanded="false"> View All <i class="feather feather-chevron-down"></i> </a>
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                <li><a href="#">Monthly</a></li>
                                <li><a href="#">Yearly</a></li>
                                <li><a href="#">Weekly</a></li>
                ...
                <div class="card-body">
                    <ul class="timeline">
                        <li>
                            <a target="_blank" href="#" class="font-weight-semibold fs-15 ml-3">Leave Approval
                                Request</a>
                        ...
                        <li class="pink">
                            <a target="_blank" href="#" class="font-weight-semibold fs-15 mb-2 ml-3">Received
                                Mail</a>
                        ...
                        <li class="success mb-0 pb-0">
                            <a target="_blank" href="#" class="font-weight-semibold fs-15 mb-2 ml-3">Job
                                Application Mail</a>
        ...
        <div class="col-xl-6 col-lg-12 col-md-12">
            <div class="card">
                <div class="card-header border-bottom-0">
                    ...
                    <div class="card-options">
                        <div class="dropdown"> <a href="#" class="btn btn-outline-light dropdown-toggle"
                                data-toggle="dropdown" aria-expanded="false"> See All <i
                                    ...
                                    <tbody>
                                        <tr class="border-bottom">
                                            <td>
                                                <div class="d-flex">
                                                    <img src="{{ asset('assets') }}/images/users/16.jpg" alt="img"
                                                        class="avatar avatar-md brround mr-3">
                                                    <div class="mr-3 mt-0 mt-sm-1 d-block">
                                            ...
                                            <td class="text-left fs-13"><i
                                                    class="feather feather-map-pin text-muted mr-2"></i>USA</td>
                                            <td class="text-right">
                                                <a href="#" class="action-btns" data-toggle="tooltip"
                                                    data-placement="top" title="Contact"><i
                                        ...
                                        <tr class="border-bottom">
                                            ...
                                            <td class="text-left fs-13"><i
                                                    class="feather feather-map-pin text-muted mr-2"></i>India</td>
                                            <td class="text-right">
                                                <a href="#" class="action-btns" data-toggle="tooltip"
                                                    data-placement="top" title="Contact"><i
                                                        class="feather feather-phone-call text-primary"></i></a>
                                        ...
                                        <tr class="border-bottom">
                                            ...
                                            <td class="text-left fs-13"><i
                                                    class="feather feather-map-pin text-muted mr-2"></i>Germany</td>
                                            <td class="text-right">
                                                <a href="#" class="action-btns" data-toggle="tooltip"
                                                    data-placement="top" title="Contact"><i
                                                        class="feather feather-phone-call text-primary"></i></a>
                                        ...
                                        <tr class="border-bottom">
                                            <td>
                                                <div class="d-flex">
                                                    <img src="{{ asset('assets') }}/images/users/8.jpg" alt="img"
                                                        class="avatar avatar-md brround mr-3">
                                                    <div class="mr-3 mt-0 mt-sm-1 d-block">
                                    ...
                                    <tbody>
                                        <tr class="border-bottom">
                                            ...
                                            <td class="text-left fs-13"><i
                                                    class="feather feather-map-pin text-muted mr-2"></i>USA</td>
                                            <td class="text-right">
                                                <a href="#" class="action-btns"><i
                                                        class="feather feather-check text-primary"></i></a>
                                                <a href="#" class="action-btns"><i
                                                        class="feather feather-help-circle  text-primary"></i></a>
                                                <a href="#" class="action-btns"><i
                                        ...
                                        <tr class="border-bottom">
                                            <td>
                                                <div class="d-flex">
                                                    <div class="table_img brround bg-light mr-3">
                                                        <img src="{{ asset('assets') }}/images/photos/html.png"
                                                            alt="img" class=" bg-light brround">
                                                    </div>
                                                    <div class="mr-3 mt-3 d-block">
                                                        <h6 class="mb-0 fs-13 font-weight-semibold">Experienced Html
                                                            Developer</h6>
                                                        <div class="clearfix"></div>
                                        ...
                                        <tr class="border-bottom">
                                            <td>
                                                <div class="d-flex">
                                                    <div class="table_img brround bg-light mr-3">
                                                        <img src="{{ asset('assets') }}/images/photos/jquery.png"
                                                            alt="img" class=" bg-light brround">
                                                    </div>
                                                    <div class="mr-3 mt-3 d-block">
                                                        <h6 class="mb-0 fs-13 font-weight-semibold">Experienced Jquery
                                                            Developer</h6>
                                                        <div class="clearfix"></div>
                                        ...
                                        <tr class="border-bottom">
                                            <td>
                                                <div class="d-flex">
                                                    <div class="table_img brround bg-light mr-3">
                                                        <img src="{{ asset('assets') }}/images/photos/vue.png"
                                                            alt="img" class=" bg-light brround">
                                                    </div>
                                                    <div class="mr-3 mt-3 d-block">
            ...
            <div class="card">
                <div class="card-header border-0">
                    ...
                    <div class="card-options ">
                        ...
                        <div class="dropdown"> <a href="#" class="btn btn-outline-light dropdown-toggle"
                                data-toggle="dropdown" aria-expanded="false"> Date <i
                                    class="feather feather-chevron-down"></i> </a>
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                <li><a href="#">Monthly</a></li>
                                <li><a href="#">Yearly</a></li>
                        ...
                        <tbody>
                            <tr class="border-bottom">
                                ...
                                <td class="text-center">
                                    <a href="#" class="action-btns" data-toggle="tooltip" data-placement="top"
                                        title="Contact"><i class="feather feather-phone-call text-primary"></i></a>
                                    <a href="#" class="action-btns" data-toggle="tooltip" data-placement="top"
                                        title="Chat"><i class="feather-message-circle  text-success"></i></a>
                                </td>
                            </tr>
                            <tr class="border-bottom">
